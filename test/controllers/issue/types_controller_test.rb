...
class Issue::TypesControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create issue_type" do
    assert_difference('Issue::Type.count') do
      post :create, issue_type: { c_type: @issue_type.c_type, code: @issue_type.code, remark: @issue_type.remark }
    end
  ...
  test "should update issue_type" do
    patch :update, id: @issue_type, issue_type: { c_type: @issue_type.c_type, code: @issue_type.code, remark: @issue_type.remark }
    assert_redirected_to issue_type_path(assigns(:issue_type))
  end

  test "should destroy issue_type" do
    assert_difference('Issue::Type.count', -1) do
